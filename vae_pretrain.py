...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(dataset=train_set, shuffle=True, batch_size=batch_size,num_workers=8,pin_memory=True, drop_last=True)
    validation_loader = DataLoader(dataset=val_set, shuffle=True, batch_size=batch_size,num_workers=8, pin_memory=True, drop_last=True)
    ...
    test_loader = DataLoader(dataset=test_set, shuffle=True, batch_size=batch_size,num_workers=8, pin_memory=True, drop_last=True)  # batch_size=100
